  ...
  <footer class="footer">
    ...
    <div class="footer__main">
      ...
      <div class="footer__company-info">
        广花设计专注室内设计、装修施工、建筑设计、厂房新建及改扩建、光伏、机电设计、景观设计、结构加固。为店铺、别墅、自建房、公寓、厂房、学校等等提供服务，10年行业经验，团队由资深设计师组成，欢迎咨询。<br><br>

        我们总部在广州，服务珠三角。
        专业承接建筑设计、混凝土结构设计、钢结构设计、水暖电设计、动力设计、幕墙设计、室内设计、室内水暖电、空调通风地暖设计、管道支架设计、消防设计、园林景观设计、市政道路设计、BIM正向设计等等。<br><br>
        
        方案设计，效果图设计，施工图设计，各种工程设计包您满意。专业出施工图，可以出效果图+全专业施工图+预算造价，包审图通过。只有问不到，没有做不到，欢迎各位领导老板咨询。
      </div>
    </div>
